...
import {HoverDirective} from './d3/directives/mousehover.directives';
import { HoverLinkDirective } from './d3/directives/mousehoverlink.directives';
...
@NgModule({
  declarations: [
    ...
    D3_DIRECTIVES,HoverDirective,HoverLinkDirective
  ],
  imports: [
    BrowserModule,
    FormsModule,
